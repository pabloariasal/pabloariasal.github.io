...
The source code for the entire series can be found [here](https://github.com/pabloariasal/couring).
Reddit discussion [here](https://www.reddit.com/r/cpp/comments/ytzd5q/c20_coroutines_and_io_uring/).
